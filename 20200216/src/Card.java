...
/*两个重要总结：
1、排序自己自定义的类型，必须实现Comparable接口，
同时重写compareTo接口。
2、如果实现Comparable接口，同时重写compareTo接口，有一个非常大的缺点。
即不能擅自修改代码否则会出现意料不到的错误。
* */
...
public class Card {
    ...
    public static void main3(String[] args) {
        ...
        people[2] = new Person1("allbuy",38);
